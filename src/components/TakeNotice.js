        ...
        <div className="h-screen bg-takeNotice bg-no-repeat bg-cover">
            ...
            <div className="w-full flex justify-center">
                <div>
                    ...
                    <div className="lg:w-[15%] xl:w-1/6 h-full flex items-center justify-end">
                            <div>
                        ...
                        <div className="h-full lg:w-[55%] xl:w-3/6 max-w-[828px] flex flex-col justify-center">
                            <h1 className="font-semibold text-2xl xl:text-3xl 2xl:text-4xl mt-10 2xl:mt-20" dangerouslySetInnerHTML={{__html: t('takeNoticeDetail')}}></h1>
                                ...
                                <ul className="flex-1">
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            ...
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.look')}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            <Image alt="gallery" src={paintIcon}/>
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.paint')}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            <Image alt="guitar" src={thinkingIcon}/>
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.think')}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            <Image alt="search" src={rainIcon}/>
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.listen')}</span>
                                        </div>
                                    </li>
                                </ul>
                                <ul className="ml-10 flex-1">
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            ...
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.play')}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            <Image alt="cook" src={familyIcon}/>
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.notice')}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="mb-4 flex items-center">
                                            <Image alt="bee" src={moonIcon}/>
                                            <span className="pl-6 max-w-[200px] xl:max-w-[250px]  2xl:max-w-[300px]">{t('takeNoticeInfo.lookAt')}</span>
                                        </div>
                                    </li>
                                    <li>
                                    <div className="">
                        ...
                        <div className="lg:w-[30%] xl:w-2/6 h-full flex flex-col justify-center items-end">
                            <div className="mt-20">
