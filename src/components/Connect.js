...
export default function Connect() {
    ...
    return (
        <div className="bg-bvsWarmWhite h-full min-h-[820px] sm:min-h-0 md:h-screen md:bg-connect bg-no-repeat bg-cover flex justify-center items-center md:block">
            <div>
                <div className="w-full hidden md:flex justify-end pt-5 pr-8">
                        ...
                        <div className="h-heightBody w-full flex items-center">
                            ...
                            <div className="h-full w-full lg:w-[55%] xl:w-3/6 max-w-[828px] pl-3 lg:pl-0 flex flex-col justify-center">
                                <div>
                                    ...
                                    <h1 className="font-semibold text-2xl xl:text-2xl 2xl:text-4xl lg:mt-10 2xl:mt-20 flex-1" dangerouslySetInnerHTML={{__html: t('connectDetail')}}/>
                                </div>
                                <div className="mt-10 2xl:mt-20">
                                    <h3 className="font-medium text-[20px] lg:text-[18px] mb-10">{t('whynot')}</h3>
                                    <div className="ml-5 text-[15px] sm:text-base lg:text-sm font-normal text-black text-opacity-70 leading-[17px]">
                                        <ul>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="family icon" src={familyImage}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.talk')}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="friend image" src={friendImage}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.help')}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="meal image" src={mealImage}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.eatMeal')}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="highfive" src={highFive}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.makeFriend')}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="hi image" src={hiImage}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.sayHello')}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="mb-8 lg:mb-4 flex items-center">
                                                    <Image alt="pie image" src={pieImage}/>
                                                    <span className="ml-6 max-w-[220px] sm:max-w-[300px] lg:max-w-[250px] xl:max-w-[270px]">{t('connectInfo.bakeSomeCakes')}</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
