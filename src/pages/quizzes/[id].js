                                                ...
                                                <table key={question.id} className="table">
                                                    ...
                                                    <tbody className="font-semibold">
                                                        <tr className={"border-b-2 border-bvsTeal"} key={question.id}>
                                                            <td className="p-3 text-center"><input type="radio" name={`question${(question.id + 1)}`} className="cursor-pointer" value="0" disabled={isDisableButton(question.id + 1)} onChange={(e) => handleSelect(e, question.id)}/></td>
                                                            <td className="p-3 text-center"><input type="radio" name={`question${(question.id + 1)}`} className="cursor-pointer" value="1" disabled={isDisableButton(question.id + 1)} onChange={(e) => handleSelect(e, question.id)}/></td>
                                                            <td className="p-3 text-center"><input type="radio" name={`question${(question.id + 1)}`} className="cursor-pointer" value="2" disabled={isDisableButton(question.id + 1)} onChange={(e) => handleSelect(e, question.id)}/></td>
                                                            <td className="p-3 text-center"><input type="radio" name={`question${(question.id + 1)}`} className="cursor-pointer" value="3" disabled={isDisableButton(question.id + 1)} onChange={(e) => handleSelect(e, question.id)}/></td>
                                                            <td className="p-3 text-center"><input type="radio" name={`question${(question.id + 1)}`} className="cursor-pointer" value="4" disabled={isDisableButton(question.id + 1)} onChange={(e) => handleSelect(e, question.id)}/></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            )
...
//     const classStr = (number) => `max-w-[470px] ${getColor(number)}`
